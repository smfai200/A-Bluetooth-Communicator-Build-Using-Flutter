...
class _ChatPage extends State<ChatPage> {
            ...
            Column(
                children: <Widget>[
                  new Row(
                        ...
                        new RaisedButton(
                          onPressed: isConnected ? () => _sendMessage("6") : null,
                ...
                new Row(
                        children: <Widget>[
                              new RaisedButton(
                                ...
                                child: Text("Track to Left"),
                              ),
                              new RaisedButton(
                                onPressed: isConnected ? () => _sendMessage("3") : null,
                                child: Text("Track to Right"),
                              ),
                              ],
                )],
            ),
  ...
  void _sendMessage_NoAdd(String text) async {
    text = text.trim();
    textEditingController.clear();
    ...
    if (text.length > 0)  {
      try {
        ...
        activateSMS();
        setState(() {
          messages.add(_Message(clientID, "Operation from SMS"));
        });
