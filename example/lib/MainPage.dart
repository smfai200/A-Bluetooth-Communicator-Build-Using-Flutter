      ...
      body: Container(
        child: ListView(
          children: <Widget>[
            ...
            ListTile(
              title: RaisedButton(
                child: const Text('Control Options'),
                onPressed: () async {
                  final BluetoothDevice selectedDevice = await Navigator.of(context).push(
            ...
            ListTile(
              title: RaisedButton(
                child: const Text('Train Schedule'),
                onPressed: () async {
                  final BluetoothDevice selectedDevice = await Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) { return ListPage(title: 'Schedules'); })
                  );
                },
              ),
            ),
